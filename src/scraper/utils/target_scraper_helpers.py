...
def process_targets(stock_return_data, stock_alpha_data, limit_array, stop_array):
    ...
    for limit in limit_array:
        for stop in stop_array:
            ...
            targets[target_key] = {
                'final_return_1d_raw'       : 0.0,
                'final_alpha_1d_raw'        : 0.0,
                'final_return_2d_raw'       : 0.0,
                'final_alpha_2d_raw'        : 0.0,
            ...
            targets[target_key]['final_return_1d_raw'] = stock_return_data.iloc[1]
            targets[target_key]['final_alpha_1d_raw'] = stock_alpha_data.iloc[1]
            
            targets[target_key]['final_return_2d_raw'] = stock_return_data.iloc[2]
            targets[target_key]['final_alpha_2d_raw'] = stock_alpha_data.iloc[2]
...
def save_targets_to_excel(results, limit_array, stop_array, output_file):
    ...
    try:
        ...
        single_column_targets = ['final_return_1d_raw', 
                                 'final_alpha_1d_raw',
                                 'final_return_2d_raw', 
                                 'final_alpha_2d_raw',
                                 'final_return_1w_raw', 
